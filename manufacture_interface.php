...
<nav>
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <?php if ($_SESSION['user_role'] === 'manufacturer') : ?>
            <li class="dropdown-item"><?php echo $_SESSION['manufacturer_data']['first_name'] . ' ' . $_SESSION['manufacturer_data']['last_name']; ?></li>
        <?php endif; ?>
        <li class="dropdown-item">My Profile</li>
        <li class="dropdown-item"><a href="?logout=1">Logout</a></li>
    </ul>
</div>
