$(document).ready(function(){
      // Get the manufacturer_id parameter from the URL
      const urlParams = new URLSearchParams(window.location.search);
      const manufacturerId = urlParams.get('manufacturer_id');
      load_rating_data(manufacturerId);
	var rating_data = 0;
        ...
        if (user_name == '' || user_review == '') {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    manufacturer_id: manufacturerId // Include manufacturer_id
                },
                success: function (data) {
                    $('#review_modal').modal('hide');
                    load_rating_data(); // Reload reviews after submitting
                    alert(data);
                }
            });
        }
