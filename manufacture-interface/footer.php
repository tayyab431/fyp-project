...
<footer class="footer">
  <div class="container">
    ...
    <script>
    // Check if the user has logged out before leaving the page
    window.onbeforeunload = function () {
        if ('<?php echo isset($_SESSION['logout_message']) ? $_SESSION['logout_message'] : ''; ?>' !== '') {
            return 'Please log out before leaving the website.';
        }
    };
</script>
