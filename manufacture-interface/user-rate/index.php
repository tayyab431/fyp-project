...
<head>
    <meta charset="utf-8" />
    <title>clothing barter|Ratings</title>
...
<body>
	...
	<a href="..\index.php" class="back-icon">
    	...
    	<h2 class="mt-5 mb-5">What customer say For <?php echo $manufacturerName; ?></h2>
    	<div class="card">
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
					...
					<input type="hidden" name="manufacturer_id" value="<?php echo $_GET['manufacturer_id']; ?>">
	        	</div>
	        	<div class="form-group">
